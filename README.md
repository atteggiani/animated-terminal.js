...
:white_check_mark: Lightweight, quick to install and easy to use<br>
:white_check_mark: No JavaScript knowledge needed<br>
:white_check_mark: No additional libraries needed<br>
:white_check_mark: Multiple functionalities and customisations<br>
...
- [Usage](#usage)
  ...
  - [Terminal *data* types](#terminal-data-types)
  - [Terminal customisation](#terminal-customisation)
    - [Customise `<terminal-window>`](#customise-terminal-window)
    - [Customise `<terminal-line>`](#customise-terminal-line)
  - [Add an Image / Video / GIF](#add-an-image--video--gif)
- [Edit elements using *::part()*](#edit-elements-using-part)

## About
**animated-terminal.js** lets you render an animated terminal window using only 2 custom HTML tags, so you can use it without having to write a single line of JavaScript yourself! 
...
- The animation starts only when the terminal is in the viewport (check the [*init* attribute](#customise-terminal-window) to change this feature).
...
By default each `<terminal-line>` will be an *output* line, but you can change this behaviour adding the [*data* attribute](#terminal-data-types) to the `<terminal-line>` or `<terminal-window>` tag.
...
| static | - | If present, turns terminal into static mode, with no animation.|

<br>

#### Customise `<terminal-line>`
